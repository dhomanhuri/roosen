...
<body class="animsition">
    ...
    <!-- Product Detail -->
    <section class="sec-product-detail bg0 p-t-65 p-b-60" id="product">
        <div class="container">
            <div class="row">
                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                ...
                                <div class="item-slick3" data-thumb="{{ asset('storage/' . $product->gambar) }}">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="{{ asset('storage/' . $product->gambar) }}" alt="IMG-PRODUCT"
                                            height="600">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{{ asset('storage/' . $product->gambar) }}">
                        ...
                        <a href="{{ url()->previous() }}#product">
                            < BACK</a>
                                ...
                                <p class="stext-102 cl3 p-t-23">
                                    Nama Petani : <span class="text-success">{{ $product->user->name }}</span>
                                </p>
                                <p class="stext-102 cl3 p-t-23">
                                    {{ $product->keterangan }}
                                </p>
                                    ...
                                    <div class="size-204 flex-w flex-m respon6-next text-center">
                                        <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                            ...
                                            <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                name="qty" min="1" max="{{ $product->stok }}"
                                                value="1">
                                        ...
                                        <input type="hidden" name="nama_petani" value="{{ $product->user->name }}">
                                        ...
                                        <button
                                            ...
                                            type="submit">
                                            {{ $cart == null ? 'Tambahkan ke keranjang' : 'Hapus dari keranjang' }}
                                        </button>
        ...
        <div class="container">
            ...
            <div class="p-t-30 p-b-30">
                ...
                <p class="stext-107 cl6 txt-center">
                    ...
                    <a href="https://colorlib.com" target="_blank">Roosen</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="product p-4">
                                ...
                                <div class="mt-4 mb-3"> <span class="text-muted brand">Petani : {{ $product->user ? $product->user->name : 'unknow' }}</span>
                                ...
                                <div class="col-5 d-flex mt-4">
                                    ...
                                    <input id="form1" min="1" max="{{ $product->stok }}" name="qty"
