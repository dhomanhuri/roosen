        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="float-right">
                    <a href="{{ url('/cart') }}" class="btn btn-lg btn-outline-primary md-btn-flat mt-2 mr-3">Back
                        to
                        cart</a>
                    {{-- Chekcout button  --}}
                    @if (
                        !empty(auth()->user()->cart->all()
                        ))
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header ">
                                    <h1 class="modal-title fs-5 text-dark" id="exampleModalLabel"><i
                                            class="fas fa-money-check text-primary"></i> Checkout</h1>
