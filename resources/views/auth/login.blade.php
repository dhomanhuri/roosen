            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url(convertedimage/mawar1.jpeg);">
                        </div>
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="{{ route('login') }}" class="signin-form" method="POST">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="form-control btn text-light rounded submit px-3"
                                        style="background-color: rgb(157,23,20);">Login In</button>
                                </div>
                            </form>
                            <p class="text-center">Tidak punya akun? <a class="text-danger"
