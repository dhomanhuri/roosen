                        ...
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="{{ route('register') }}" class="signin-form" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="Email" required
                                        name="name" >
                                ...
                                <div class="form-group">
                                    <button type="submit" class="form-control btn text-light rounded submit px-3"
                                        style="background-color: rgb(157,23,20);">Register</button>
                                </div>
                            </form>
                            <p class="text-center">Sudah punya akun? <a class="text-danger"
