...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if (auth()->user()->role == 'pembeli')
                <li class="nav-item">
                    <a class="nav-link collapsed" href="{{ url('/index#product') }}" aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fab fa-product-hunt"></i>
                        <span>Product</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="{{ url('/riwayat-transaksi') }}" aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-money-check-alt"></i>
    ...
    @if( !str_contains(Request::path(), 'cart/petani/') )
